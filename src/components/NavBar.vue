<template>
	<nav>
		...
		<div class="links-container">
			...
			<ScrollLink text="Planes" href="#planes" />
			<RedirectLink text="Regístrate" href="#registrate" />
			<MainButton text="Inicia Sesión" />
		</div>
	</nav>
</template>
...
export default {
	components: { ScrollLink, RedirectLink, MainButton },
}
</script>
